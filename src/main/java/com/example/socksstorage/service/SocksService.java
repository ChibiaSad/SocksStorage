...
import com.example.socksstorage.exception.NotEnoughSocksException;
import com.example.socksstorage.exception.OperationDoesNotExist;
import com.example.socksstorage.mapper.SocksMapper;
...
public class SocksService {
    ...
    public Integer getCount(String color, String operation, int cottonPart) {
        ...
        switch (operation) {
            ...
            default: log.error("there is no operation named " + operation);
